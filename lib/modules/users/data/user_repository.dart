...
import 'package:pizza_delivery_api/application/exceptions/user_not_found_exception.dart';
...
class UserRepository implements IUserRepository {
  ...
  Future<User> login(String email, String password) async {
    final conn = await _connection.openConnection();
    try {
      final result = await conn.query('select * from usuario where email = ? and senha = ?',
