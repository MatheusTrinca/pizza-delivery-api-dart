...
class OderRepository implements IOrderRepository {
  final IDatabaseConnection _connection;

  OderRepository(this._connection);
    ...
    try {
      ...
      if (ordersResult.isNotEmpty) {
        for (var orderResult in ordersResult) {
          ...
          final orderItemresult = await conn.query('''
            select 
          ...
          final items = orderItemresult.map((orderData) {
            final itemFields = orderData.fields;
            return OrderItems(
